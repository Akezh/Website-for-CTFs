...
<aside class="w-64 fixed top-16" aria-label="Sidebar">
    <div class="overflow-y-auto pt-3 px-3 bg-gray-50" style="background-color: #0c1221; height: 100vh">
        <ul class="space-y-3">
            <li>
                <a href="/" class="flex items-center p-2 pl-2 text-base font-normal rounded-lg text-white hover:bg-gray-700">
            ...
            {#if $userStore.isLoggedIn}
                <li>
                    <a href="/challenges"
                       class="flex items-center p-2 pl-2 text-base font-normal rounded-lg text-white hover:bg-gray-700">
            ...
            {/if}
            <li>
                <a href="/leaderboard" class="flex items-center p-2 text-base font-normal rounded-lg text-white hover:bg-gray-700">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {#if !$userStore.isLoggedIn}
                <li>
                    <a href="/login" class="flex items-center p-2 text-base font-normal rounded-lg text-white hover:bg-gray-700">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="/register" class="flex items-center p-2 text-base font-normal rounded-lg text-white hover:bg-gray-700">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 text-gray-400 group-hover:text-gray-900 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clip-rule="evenodd"></path></svg>
            ...
            <li>
                <a href="/about" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg text-white hover:bg-gray-700">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
