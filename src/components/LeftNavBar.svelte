...
<aside class="w-64 fixed top-16" aria-label="Sidebar">
    <div class="overflow-y-auto pt-3 px-3 bg-gray-50" style="background-color: #0c1221; height: 100vh">
        <ul class="space-y-3">
            <li>
                <a href="/" class="flex items-center p-2 pl-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700">
            ...
            {#if $userStore.isLoggedIn}
                <li>
                    <a href="/challenges"
                       class="flex items-center p-2 pl-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                    d="M19 4H6V2H4V20H3V22H7V20H6V15H19C19.2652 15 19.5196 14.8946 19.7071 14.7071C19.8946 14.5196 20 14.2652 20 14V5C20 4.73478 19.8946 4.48043 19.7071 4.29289C19.5196 4.10536 19.2652 4 19 4V4Z"
                                    fill="#748499"/>
                        </svg>
            ...
            {/if}
            <li>
                <a href="/leaderboard" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {#if !$userStore.isLoggedIn}
                <li>
                    <a href="/login" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="/register" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700">
            ...
            <li>
                <a href="/about" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.5 7H24.5M8.16667 14H19.8333M5.83333 21H22.1667" stroke="#748499" stroke-width="2" stroke-linecap="round"/>
                    </svg>

                    <span class="ml-4 uppercase text-sm">About CTF</span>
                </a>
            </li>
        </ul>
    </div>
